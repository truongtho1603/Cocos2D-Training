...
- (void)initJoystickAndButtons {
    ...
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        jumpButtonPosition = ccp(screenSize.width*(1.0f - 0.0946f),
                                 screenSize.height*0.104f);
        
        attackButtonPosition = ccp(screenSize.width*(1.0f - 0.0947f),
                                   screenSize.height*0.0338f);
    }
    else {
